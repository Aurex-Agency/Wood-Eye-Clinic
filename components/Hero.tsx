...
export default function Hero() {
  ...
  return (
    <section id="hero" data-track-location="hero" className="relative -mt-[92px] flex min-h-[42rem] items-center overflow-hidden px-4 pb-12 pt-24 sm:-mt-[108px] sm:px-6 sm:pb-16 sm:pt-36 lg:min-h-[48rem]">
