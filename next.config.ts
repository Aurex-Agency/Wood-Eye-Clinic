...
const legacyRedirects = [
  ...
  // /appointment is a real page now, so it is NOT redirected. The legacy
  // .html variants point at it rather than at /contact.
  { source: "/appointment.html", destination: "/appointment" },
  { source: "/appointments.html", destination: "/appointment" },
